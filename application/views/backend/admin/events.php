        ...
        <?php echo form_open(base_url() . 'admin/news/create_event/', array('enctype' => 'multipart/form-data')); ?>
          ...
          <div class="form-group">
            <label for=""> <?php echo get_phrase('title');?></label><input class="form-control" placeholder="" type="text" required="" name="title">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <label for=""> <?php echo get_phrase('from');?></label><input class="single-daterange form-control" required="" name="from" type="text">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label for=""> <?php echo get_phrase('until');?></label><input class="single-daterange form-control" name="to" required type="text">
                </div>
              </div>
            </div>
		  <div class="form-group">
