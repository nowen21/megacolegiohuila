	...
	<div class="col-sm-4">
      <div class="element-box shadow lined-success">
		...
		<?php echo form_open(base_url() . 'admin/sms/android');?>
			...
			<div class="form-group row">
			  <div class="col-sm-12">
			  <label class="col-form-label" for=""> <?php echo get_phrase('email');?></label>
			  <div class="input-group">
				<div class="input-group-addon">
					<i class="picons-thin-icon-thin-0319_email_mail_post_card"></i>
				</div>
			  <input class="form-control" name="android_email" value="<?php echo $this->db->get_where('settings', array('type' => 'android_email'))->row()->description;?>" required type="email">
			  </div>
			</div>
			</div>
			 ...
			 <div class="form-group row">
			  ...
			  <input class="form-control" name="android_password" type="password" value="<?php echo $this->db->get_where('settings', array('type' => 'android_password'))->row()->description;?>" required="">
			  </div>
			</div>
			</div>
			...
			<div class="form-group row">
			  ...
			  <input class="form-control" type="text" name="android_device" value="<?php echo $this->db->get_where('settings', array('type' => 'android_device'))->row()->description;?>" required="">
			  </div>
			</div>
			</div>
